...
contract RedeployFactoryScript is Script {
    function run() external {
        ...
        console.log("Redeploying TopUpWalletFactory with account:", deployer);
        ...
        // Deploy new TopUpWalletFactory with existing TollCollection
        TopUpWalletFactory factory = new TopUpWalletFactory(existingTollCollection);
        console.log("New TopUpWalletFactory deployed at:", address(factory));
        ...
        console.log("New TopUpWalletFactory:", address(factory));
